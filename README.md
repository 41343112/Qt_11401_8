...
- **線上對戰模式** 🆕：
  ...
  - 📖 [踩地雷模式說明](docs/BOMB_CHESS_FEATURE.md) - 地雷西洋棋變體
  - 📖 [骰子模式說明](docs/DICE_MODE_FEATURE.md) - 隨機棋子選擇變體
- **AI 人機對弈**：
