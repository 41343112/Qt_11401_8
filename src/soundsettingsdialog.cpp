...
void SoundSettingsDialog::applyModernDialogStyle()
{
    ...
    QString styleSheet = QString(
        ...
        "  border: 2px solid %4; border-radius: 3px; background-color: %2; "
        "}"
        ...
        "}"
        "QLineEdit { "
        "  background-color: %2; color: %6; border: 2px solid %4; "
        "  border-radius: 4px; padding: 4px 8px; "
        "}"
        "QLineEdit:focus { border-color: %3; }"
        "QPushButton { "
        "  background-color: %5; "
        "  color: %6; border: 2px solid %4; border-radius: 6px; "
        ...
        "  border: 2px solid %4; height: 6px; "
        "  background-color: %1; "
        "  border-radius: 3px; "
        "}"
        "QSlider::handle:horizontal { "
        "  background-color: %3; "
        "  border: 2px solid %3; width: 18px; margin: -7px 0; border-radius: 9px; "
        "}"
